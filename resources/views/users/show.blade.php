                    ...
                    <div class="card">
                        ...
                        <div class="card-footer py-1 d-flex justify-content-end bg-white">
                            ...
                            <div class="d-flex align-items-center">
                                @if (!in_array(Auth::user()->id, array_column($timeline->like->toArray(), 'user_id'), TRUE))
                                ...
                                @else
                                    <form method="POST"action="{{ url('likes/' .array_column($timeline->like->toArray(), 'id', 'user_id')[Auth::user()->id]) }}" class="mb-0">
                                        @csrf
                                        @method('DELETE')
                                ...
                                @endif
                                <p class="mb-0 text-secondary">{{ count($timeline->like) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
